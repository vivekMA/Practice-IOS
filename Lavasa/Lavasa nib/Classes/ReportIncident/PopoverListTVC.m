...
- (void)viewDidLoad
{
    ...
    arrList = [NSArray arrayWithObjects:@"Road issue",@"Apartment issue", @"Villia issue",@"item 1", @"XYZ",@"Testing item", nil];
...
{
    [self.delegate popoverListSelctedItem:[self.arrList objectAtIndex:indexPath.row]];
