...
#define KSelectedCat @"hospital"
@interface AttractionTab4 ()

@end

@implementation AttractionTab4
...
- (IBAction)MapButtonClicked:(id)sender {
    ...
    NSMutableURLRequest *theRequest = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/nearbysearch/xml?location=%@,%@&radius=2000&distancesensor=false&types=hospital&key=AIzaSyALby-zmBjk4ZHRPXmyNXcwIJ5Fj39xaTE",[NSString stringWithFormat:@"%f", coordinateLocal.latitude],[NSString stringWithFormat:@"%f", coordinateLocal.longitude]]]];
