...
//       DetailTabVC *AttTabVC = (DetailTabVC*)[mainStoryboard instantiateViewControllerWithIdentifier: @"DetailTabVC"];
//    
//    [self.navigationController addChildViewController:[[UINavigationController alloc] initWithRootViewController:AttTabVC]];
}
