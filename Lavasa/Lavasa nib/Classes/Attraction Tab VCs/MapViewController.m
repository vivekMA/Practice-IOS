...
- (NSMutableArray *)geoLocations{
    ...
    for (int i=0; i<self.AllPlaces.count; i++) {
        ...
        tempLocation = [[CLLocation alloc] initWithLatitude:place.location.coordinate.latitude longitude:place.location.coordinate.longitude];
        
        tempCoordinate = [ARGeoCoordinate coordinateWithLocation:tempLocation locationTitle:place.placeName locationRating:place.rating];
